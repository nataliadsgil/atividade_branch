...
public class JanelaPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        JanelaCliente.setText("janela cliente");
        JanelaCliente.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                JanelaClienteActionPerformed(evt);
            }
        });
        janelas.add(JanelaCliente);

        jMenuBar1.add(janelas);
    ...
    private javax.swing.JMenu janelas;
